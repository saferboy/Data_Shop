...
const { secret, expiresIn } = jwt_config_1.default;
const client = redis.createClient();
const jwtr = new jwt_redis_1.default(client);
client.connect();
...
const verify = (token) => __awaiter(void 0, void 0, void 0, function* () {
    return yield jwtr.verify(token, secret);
});
exports.verify = verify;
//# sourceMappingURL=redis.jwt.service.js.map